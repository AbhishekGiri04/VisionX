      ...
      <div className="footer-content">
        <div className="footer-section">
          <div className="footer-brand">
            <h3>VisionX</h3>
            <p>Pioneering the future of AI-powered computer vision technology</p>
          </div>
        ...
        <div className="footer-section">
          <h4>✨ Features</h4>
          <ul className="footer-links">
            <li><a href="#" onClick={() => setActivePage('face')}>Face Detection</a></li>
            <li><a href="#" onClick={() => setActivePage('object')}>Object Recognition</a></li>
            <li><a href="#" onClick={() => setActivePage('about')}>About Platform</a></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          ...
          <div className="footer-badges">
            ...
            <span className="badge realtime-badge">
              <span className="badge-emoji">⚡</span>
              Real-time
            </span>
